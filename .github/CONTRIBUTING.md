...
1. Take a look at the `.jsbeautifyrc` [settings help](https://github.com/Marvello/VSCodeBeautify/blob/master/Settings.md) file.
...
If you want to start hacking away, please check out [js-beautify for VS Code](https://github.com/Marvello/VSCodeBeautify) first. The first steps to editing this extensions are:
